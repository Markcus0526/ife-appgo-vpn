...
namespace AppGo.Controller
{
    static class AutoStartup
    {
        ...
        private static string Key = "AppGo_" + Application.StartupPath.GetHashCode();
            ...
            try
            {
                ...
                foreach (string item in runList)
                {
                    if (item.Equals(Key, StringComparison.OrdinalIgnoreCase))
                        return true;
                    else if (item.Equals("AppGo", StringComparison.OrdinalIgnoreCase)) // Compatibility with older versions
                    {

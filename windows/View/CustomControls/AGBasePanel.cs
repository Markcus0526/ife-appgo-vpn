...
{
    abstract public class AGBasePanel : Panel
    {
        /// <summary>
        ...
        {
            AGBasePanel.DrawText(this.graphics, text, "Microsoft Sans Serif", 8.25f
        ...
        protected void DrawText(string text, float fontSize, FontStyle style, Brush color
            , Point position)
        {
            AGBasePanel.DrawText(this.graphics, text, "Microsoft Sans Serif", fontSize
                , style, color, position);
        }
        ...
        {
            AGBasePanel.DrawText(this.graphics, text, fontFamily, fontSize, style, color, position);
        }

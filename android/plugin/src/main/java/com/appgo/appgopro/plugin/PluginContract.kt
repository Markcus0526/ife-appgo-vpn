...
object PluginContract {
     ...
     *
     * Constant Value: "com.appgo.appgopro.plugin.ACTION_NATIVE_PLUGIN"
     */
    const val ACTION_NATIVE_PLUGIN = "com.appgo.appgopro.plugin.ACTION_NATIVE_PLUGIN"

    /**
     * Activity Action: Used for ConfigurationActivity.
     *
     * Constant Value: "com.appgo.appgopro.plugin.ACTION_CONFIGURE"
     */
    const val ACTION_CONFIGURE = "com.appgo.appgopro.plugin.ACTION_CONFIGURE"
    /**
     * Activity Action: Used for HelpActivity or HelpCallback.
     *
     * Constant Value: "com.appgo.appgopro.plugin.ACTION_HELP"
     */
    const val ACTION_HELP = "com.appgo.appgopro.plugin.ACTION_HELP"

    /**
     * The lookup key for a string that provides the plugin entry binary.
     *
     * Example: "/data/data/com.appgo.appgopro.plugin.obfs_local/lib/libobfs-local.so"
     *
     * Constant Value: "com.appgo.appgopro.plugin.EXTRA_ENTRY"
     */
    const val EXTRA_ENTRY = "com.appgo.appgopro.plugin.EXTRA_ENTRY"
    /**
     * The lookup key for a string that provides the options as a string.
     *
     * Example: "obfs=http;obfs-host=www.baidu.com"
     *
     * Constant Value: "com.appgo.appgopro.plugin.EXTRA_OPTIONS"
     */
    const val EXTRA_OPTIONS = "com.appgo.appgopro.plugin.EXTRA_OPTIONS"
    /**
     ...
     *
     * Constant Value: "com.appgo.appgopro.plugin.EXTRA_HELP_MESSAGE"
    </host_name> */
    const val EXTRA_HELP_MESSAGE = "com.appgo.appgopro.plugin.EXTRA_HELP_MESSAGE"

    /**
     * The metadata key to retrieve plugin id. Required for plugins.
     *
     * Constant Value: "com.appgo.appgopro.plugin.id"
     */
    const val METADATA_KEY_ID = "com.appgo.appgopro.plugin.id"
    /**
     * The metadata key to retrieve default configuration. Default value is empty.
     *
     * Constant Value: "com.appgo.appgopro.plugin.default_config"
     */
    const val METADATA_KEY_DEFAULT_CONFIG = "com.appgo.appgopro.plugin.default_config"
     ...
     */
    const val AUTHORITY = "com.appgo.appgopro"
}

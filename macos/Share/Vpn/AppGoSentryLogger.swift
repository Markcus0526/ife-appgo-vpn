...
class AppGoSentryLogger: DDAbstractLogger {
...
#if os(macOS)
  private static let kAppGroup = "3W5J6994PB.com.appgo.macos"
#else
  private static let kAppGroup = "group.com.appgo.appgoios2"
#endif
  ...
  func initializeLogging() {
    ...
    let containerUrl = FileManager.default.containerURL(
      forSecurityApplicationGroupIdentifier: AppGoSentryLogger.kAppGroup)
    ...
    for logFileInfo in self.fileLogger.logFileManager.sortedLogFileInfos {
      ...
      do {
        ...
        for line in logLines {
          //RCJ if numBreadcrumbsAdded >= AppGoPlugin.kMaxBreadcrumbs {
          //  return
          //}

...
// Properties must be kept in sync with ServerConfig in www/types/AppGoPlugin.d.ts
@objcMembers
class AppGoConnection: NSObject, Codable {
  var id: String?
  var host: String?
  var port: String?
  var method: String?
  ...
  static func decode(_ jsonData: Data) -> AppGoConnection? {
    return try? JSONDecoder().decode(AppGoConnection.self, from: jsonData)
  }

...
open class Country {
    open static func getFlagName(_ code: String) -> String {
    ...
    open static func getCountryName(_ code: String, locale localeCode: String) -> String {
        for i in 0..<countryInfos.count {
            if code == countryInfos[i].code {
    ...
    open static func getCryptPhoneNumber(_ mobile: String) -> String {
        ...
        for i in 0..<countryInfos.count {
            ...
            if countrycode == countryInfos[i].phoneCode {
                cryptNumber = mobile.substring(with: (mobile.index(mobile.startIndex, offsetBy: 4) ..< mobile.index(mobile.startIndex, offsetBy: 7))) +
                    fillCryptCode(mobile.count-10) +
            ...
            if countrycode == countryInfos[i].phoneCode {
                cryptNumber = mobile.substring(with: (mobile.index(mobile.startIndex, offsetBy: 3) ..< mobile.index(mobile.startIndex, offsetBy: 6))) +
                    fillCryptCode(mobile.count-9) +
                    mobile.substring(from: mobile.index(mobile.startIndex, offsetBy: mobile.count-3))
                break
            }
            ...
            if countrycode == countryInfos[i].phoneCode {
                cryptNumber = mobile.substring(with: (mobile.index(mobile.startIndex, offsetBy: 2) ..< mobile.index(mobile.startIndex, offsetBy: 5))) +
                    fillCryptCode(mobile.count-8) +
                    mobile.substring(from: mobile.index(mobile.startIndex, offsetBy: mobile.count-3))
                break
            }
        }
    ...
    open static func getNativePhoneNumber(_ mobile: String) -> String {
        ...
        for i in 0..<countryInfos.count {
            var countrycode = mobile.substring(to: mobile.index(mobile.startIndex, offsetBy: 4))
            if countrycode == countryInfos[i].phoneCode {
                nativeNumber = mobile.substring(from: mobile.index(mobile.startIndex, offsetBy: 4))
                break
            }
            
            countrycode = mobile.substring(to: mobile.index(mobile.startIndex, offsetBy: 3))
            if countrycode == countryInfos[i].phoneCode {
                nativeNumber = mobile.substring(from: mobile.index(mobile.startIndex, offsetBy: 3))
                break
            }
            
            countrycode = mobile.substring(to: mobile.index(mobile.startIndex, offsetBy: 2))
            if countrycode == countryInfos[i].phoneCode {
                nativeNumber = mobile.substring(from: mobile.index(mobile.startIndex, offsetBy: 2))
                break
            }
        }
    ...
    open static func fillCryptCode(_ count: Int) -> String {
        var result: String = ""
        for _ in 0..<count {
            result += "*"
        }

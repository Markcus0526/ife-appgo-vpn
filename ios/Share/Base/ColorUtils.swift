...
struct Color {
    ...
    static let TextMost = UIColor.black
    static let TextPrimary = "404040".color
    static let TextSecond = "555555".color
    static let TextHint = "C8C8C8".color
    
    // AppGoPro color
    static let AppGoProTabItemDefault = "7791FF".color
    
    static let TextReadonly = "AAAAAA".color
    static let TextActive = "58C7FF".color
    static let TextGreen = "02D28B".color
    static let BackBlue = "58C7FF".color

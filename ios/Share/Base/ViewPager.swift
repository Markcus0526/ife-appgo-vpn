...
open class ViewPager: UIView {
    ...
    func setupPageControl() {
        ...
        self.pageControl.currentPageIndicatorTintColor = Color.BackBlue
...
extension ViewPager{
    ...
    func animationNext(){
        //NSTimer.scheduledTimerWithTimeInterval(2, target: self, selector: #selector(ViewPager.moveToNextPage), userInfo: nil, repeats: false)
        moveToNextPage()
    }

...
object Key {
    ...
    const val modeProxy = "modeProxy"
    const val modeTransproxy = "modeTransproxy"
}

object Action {
    const val SERVICE = "com.appgo.appgopro.SERVICE"
    const val CLOSE = "com.appgo.appgopro.CLOSE"
    const val RELOAD = "com.appgo.appgopro.RELOAD"

    const val EXTRA_PROFILE_ID = "com.appgo.appgopro.EXTRA_PROFILE_ID"
}

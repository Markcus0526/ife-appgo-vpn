...
import com.appgo.appgopro.VpnRequestActivity
import com.appgo.appgopro.acl.Acl
import com.appgo.appgopro.database.DataStore
import com.appgo.appgopro.utils.Subnet
import com.appgo.appgopro.utils.parseNumericAddress
...
class VpnService : BaseVpnService(), LocalDnsService.Interface {
    ...
    private inner class ProtectWorker : LocalSocketListener("AppGoVpnThread") {
    ...
    override val tag: String get() = "AppGoVpnService"
    ...
    private fun startVpn(): Int {
        ...
        when (profile.route) {
            Acl.INTERNATIONAL, Acl.ALL -> builder.addRoute("0.0.0.0", 0)
            else -> {

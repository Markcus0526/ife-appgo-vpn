 ...
 *    &lt;application&gt;
 *        ...
 *        &lt;provider android:name="com.appgo.appgopro.$PLUGIN_ID.BinaryProvider"
 *                     android:authorities="com.appgo.appgopro.plugin.$PLUGIN_ID.BinaryProvider"&gt;
 *            &lt;intent-filter&gt;
 *                &lt;category android:name="com.appgo.appgopro.plugin.ACTION_NATIVE_PLUGIN" /&gt;
 *            &lt;/intent-filter&gt;
 *        &lt;/provider&gt;
 *        ...
 *    &lt;/application&gt;
